...
class PortfolioApp {
    ...
    initNavigation() {
        ...
        // Mobile menu toggle - FIXED with better event handling
        if (navToggle && navMenu) {
            ...
            navToggle.addEventListener('touchend', (e) => {
                e.preventDefault();
                e.stopPropagation();
                console.log('Mobile menu toggle touched'); // Debug
                this.toggleMobileMenu();
            });
        }

        // Close mobile menu when clicking outside - FIXED to not interfere with toggle
        document.addEventListener('click', (e) => {
            if (navbar && navMenu) {
